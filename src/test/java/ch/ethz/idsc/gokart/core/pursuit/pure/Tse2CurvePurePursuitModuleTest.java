...
import ch.ethz.idsc.gokart.core.pursuit.pure.Tse2CurvePurePursuitModule;
...
public class Tse2CurvePurePursuitModuleTest extends TestCase {
  public void testSimple() {
    ...
    tse2CurvePurePursuitModule.getEvent(GokartPoseEvents.offlineV1(Tensors.fromString("{1[m],2[m],3}"), RealScalar.of(.8)));
