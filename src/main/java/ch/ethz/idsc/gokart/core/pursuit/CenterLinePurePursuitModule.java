...
public class CenterLinePurePursuitModule extends AbstractModule implements MPCBSplineTrackListener {
  ...
  public void mpcBSplineTrack(Optional<MPCBSplineTrack> optional) {
    ...
    curvePursuitModule.setCurve(Optional.ofNullable(curve), closed);
    if (Objects.nonNull(globalViewLcmModule))
